...
each stereosource is connected with thin lines to corresponding Infospace. Also those 
are colorcoded (I would prefer straight connections, could be possible if they are 
colored).
